...
IMG ?= $(REPO)work-placement-controller:latest
...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=work-placement crd paths="./..." output:crd:artifacts:config=config/crd
...
build: vendor generate fmt vet ## Build manager binary.
	go build -o bin/manager pkg/main.go
