...
make run
```
You will see the log output on the console. 
...
Now, you can follow the [getting started guide](./README.md) to work with the open-cluster-management work-placement-controller repository.